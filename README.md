...
- Solution URL: [Solution URL](https://github.com/nishanth1596/bookmark-landing-page)
- Live Site URL: [Live site URL](https://nishanth-bookmark-landing-page.netlify.app/)
...
1. Clone this repository:
   ...
   ```bash
   git clone https://github.com/nishanth1596/bookmark-landing-page.git
   ```
