  ...
  return (
    <footer className="mt-[123px] text-center text-white">
      <section className="bg-Blue px-8 py-[3.75rem]">
        ...
        <form
          className="mt-8 md:flex md:items-start md:justify-center md:gap-4"
        ...
        >
          <div className="relative">
            ...
            <input
              className={`text-Black ${errors.email ? "outline-Orange focus:outline-Orange active:outline-Orange outline-2" : ""} active:outline-Blue focus:outline-Blue w-full max-w-[300px] rounded-[5px] bg-white px-5 py-2.5 pr-8 text-sm leading-7 font-normal tracking-[0.25px]`}
              type="text"
